...
| `@usejunior/email-agent-mcp` | Distributionspaket (`npx @usejunior/email-agent-mcp`) |
...
Ja. Fuehren Sie `npx @usejunior/email-agent-mcp` aus, um den MCP-Server zu starten, und konfigurieren Sie ihn dann in Ihren Claude Code-Einstellungen.
