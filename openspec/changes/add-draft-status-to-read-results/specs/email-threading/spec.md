...
Without it, a thread read renders a draft reply as though the user had already replied — the most consequential place for the confusion, because the draft is the newest message in the thread and reads as the conversation's outcome.
